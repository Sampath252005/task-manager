      ...
      >
        ...
        <div className="flex items-center gap-6 mb-8">
          ...
          <div className="flex flex-col">
            <span className="font-bold text-sm text-black dark:text-gray-400 dark:bg-slate-700 bg-white px-3 py-1 rounded-full w-fit mb-2">
              Owner
            </span>
            <h2 className="text-sm md:text-2xl font-semibold text-blue-600 dark:text-white ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-10">
          <div className="flex flex-col">
            <label className="mb-2 text-sm text-black dark:text-gray-400">
              Name
            </label>
            <div className=" dark:text-white text-blue-600 bg-white dark:bg-[#1f2937] p-3 rounded-3xl border border-gray-600 cursor-not-allowed">
              {capitalizeFirstLetter(user?.username)}
            </div>
          </div>
          <div className="flex flex-col">
            ...
            <div className="dark:text-white text-blue-600 bg-white dark:bg-[#1f2937] p-3 rounded-3xl border border-gray-600 cursor-not-allowed hover:border-red-500 hover:border max-w-xs overflow-hidden text-ellipsis whitespace-nowrap">
              {user?.email}
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 border border-gray-600 rounded-2xl p-4 text-sm text-gray-400">
          <p className="mb-1 font-semibold dark:text-white text-red-500">
            Delete account
          </p>
          Contact our{" "}
