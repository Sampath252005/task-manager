...
const TaskCard = ({
  ...
  return (
    <>
      <div className="relative bg-white dark:bg-[#071E3D] shadow-md rounded-2xl p-4 m-2 sm:p-6 max-w-full sm:max-w-md md:max-w-lg lg:max-w-xl w-full justify-center items-center">
          ...
          <div className="flex items-center justify-between text-gray-500 dark:text-gray-400 text-xs sm:text-sm">
            ...
            <button
              onClick={() => {
                ...
                setTimeout(() => setShowTaskDoneAnimation(false), 3000); // hides animation after 3s
              }}
